...
var Floorplanner = function(_canvas, _floorplan) {
  ...
  var canvasElement = $("#"+_canvas);

  var view = new FloorplannerView(_floorplan, this, _canvas);
  ...
  function init() {
    ...
    _floorplan.roomLoadedCallbacks.add(scope.reset);
  }
  ...
  function mousemove(event) {
    ...
    if (scope.mode != scope.modes.DRAW && !mouseDown) {
      var hoverCorner = _floorplan.overlappedCorner(mouseX, mouseY);
      var hoverWall = _floorplan.overlappedWall(mouseX, mouseY);
      var draw = false;
  ...
  function mouseup() {
    ...
    if (scope.mode == scope.modes.DRAW && !mouseMoved) {
      var corner = _floorplan.newCorner(scope.targetX, scope.targetY);
      if (scope.lastNode != null) {
        _floorplan.newWall(scope.lastNode, corner);
      }
